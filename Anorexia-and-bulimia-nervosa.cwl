...
steps:
  ...
  atypical-anorexia-and-bulimia-nervosa---secondary:
    run: atypical-anorexia-and-bulimia-nervosa---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: anorexia---secondary/output
  bulimia---secondary:
    run: bulimia---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: atypical-anorexia-and-bulimia-nervosa---secondary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: bulimia---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
